...
#include <fedtime.hh>
char federateName[12]= "<MODULE_02>";
...
//		myTarget->Subscribing();
		...
		//int Dnum = mxGetM(beamPosition);
		int Bnum = mxGetN(beamPosition);
		engEvalString(ep, " DetectionResult3=[];");
		engEvalString(ep, " DetectionResult4=[];");
		engEvalString(ep, "currentjob3 = jobq3.SearchQueue(61);");
		engEvalString(ep, "jobq3.SearchIndex = 61;");
		engEvalString(ep, "currentjob4 = jobq4.SearchQueue(200);");
		engEvalString(ep, "jobq4.SearchIndex = 200;");
		cout << endl << "---------------------------------------" << endl;
