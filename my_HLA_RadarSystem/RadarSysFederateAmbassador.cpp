		...
		RTI::FederateInternalError)
{
	...
	{
		cout << endl;
		cout << "startRegistrationForObjectClass ID: " << Target::GetTargetRtiId() <<" callback" << endl;
	...
	{
		cout << endl;
		cout << "startRegistrationForObjectClass ID: " << Radar::GetRadarRtiId() << " callback" << endl;
		...
		RTI::FederateInternalError)
{
	...
	cout << endl << "###---------------------------------------" << endl;
	cout << "### discoverObjectInstance callback for: "
		...
		RTI::FederateInternalError)
{
	...
	if (pTarget)
	{
		cout << "###Found Target: " << pTarget->GetName() << endl;
		try
		{
			RTI::ULong length;
	...
	if (pRadar)
	{
		cout << "###Found Radar: " << pRadar->GetName() << endl;
		try
		{
			RTI::ULong length;
			for (unsigned int a = 0; a < theAttributes.size(); a++)
