function [mfradar1,BeamWidth] = setRadar1(fc,fs,posx,posy,posz)
...
mfradar1.ArrayGain = arraygain;
mfradar1.Transmitter      = transmitter;
mfradar1.Receiver      = receiver;
mfradar1.Radiator   = radiator;
mfradar1.Collector   = collector;
mfradar1.Wav     = waveform;
mfradar1.NPower = npower;

mfradar1.FGates = fast_time_grid;
mfradar1.RGates = range_gates;
mfradar1.RxFeed  = monoFeed;
mfradar1.MFCoeff = mfcoeff;
mfradar1.MF      = mf;
mfradar1.AGC     = agc;
mfradar1.STV     = steeringvec;
mfradar1.Position = sensormotion;
end
