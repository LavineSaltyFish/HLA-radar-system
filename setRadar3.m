function [mfradar3,BeamWidth] = setRadar3(fc,fs,posx,posy,posz)
...
mfradar3.ArrayGain = arraygain;
mfradar3.Transmitter      = transmitter;
mfradar3.Receiver      = receiver;
mfradar3.Radiator   = radiator;
mfradar3.Collector   = collector;
mfradar3.Wav     = waveform;
mfradar3.NPower = npower;

mfradar3.FGates = fast_time_grid;
mfradar3.RGates = range_gates;
mfradar3.RxFeed  = monoFeed;
mfradar3.MFCoeff = mfcoeff;
mfradar3.MF      = mf;
mfradar3.AGC     = agc;
mfradar3.STV     = steeringvec;
mfradar3.Position = sensormotion;
end
