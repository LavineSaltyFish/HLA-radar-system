function [mfradar4,BeamWidth] = setRadar4(fc,fs,posx,posy,posz)
...
mfradar4.ArrayGain = arraygain;
mfradar4.Transmitter      = transmitter;
mfradar4.Receiver      = receiver;
mfradar4.Radiator   = radiator;
mfradar4.Collector   = collector;
mfradar4.Wav     = waveform;
mfradar4.NPower = npower;

mfradar4.FGates = fast_time_grid;
mfradar4.RGates = range_gates;
mfradar4.RxFeed  = monoFeed;
mfradar4.MFCoeff = mfcoeff;
mfradar4.MF      = mf;
mfradar4.AGC     = agc;
mfradar4.STV     = steeringvec;
mfradar4.Position = sensormotion;
end
